...
export const triviaQuestions: TriviaQuestion[] = [
  ...
  {
    id: 4,
    question: 'What was the name of Singapore\'s first cinema, opened in 1907?',
    options: [
  ...
  },
  {
    ...
    options: [
      { label: 'A', text: '3.2 million' },
      { label: 'B', text: '4.5 million' },
      { label: 'C', text: '5.6 million' },
      { label: 'D', text: '7.1 million' },
    ],
    correctAnswer: 'C',
  },
  {
  ...
  {
    id: 10,
    question: 'For how many consecutive years has Changi Airport been voted the world\'s best?',
    options: [
      { label: 'A', text: '5 years' },
      { label: 'B', text: '8 years' },
      { label: 'C', text: '12 years' },
  ...
  },
  {
    ...
    options: [
      { label: 'A', text: 'Over 40' },
      { label: 'B', text: 'Over 60' },
      { label: 'C', text: 'Over 80' },
      { label: 'D', text: 'Over 100' },
    ],
    correctAnswer: 'C',
  },
  {
