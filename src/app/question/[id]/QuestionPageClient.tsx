...
export default function QuestionPageClient({ id }: { id: string }) {
  ...
  return (
    ...
    >
      {/* Back button - luxury styling */}
      <button
        onClick={handleBack}
        className="btn-press w-full py-3.5 rounded-xl bg-white/5 border border-white/10 text-white/60 font-medium hover:bg-white/10 hover:text-white hover:border-gold/30 transition-all flex items-center justify-center gap-2"
      >
