...
export default function QuestionPageClient({ id }: { id: string }) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handleBack}
        className="btn-press w-full py-2.5 sm:py-3.5 rounded-lg sm:rounded-xl bg-white/5 border border-white/10 text-white/50 text-xs sm:text-base font-medium hover:bg-white/10 hover:text-white hover:border-primary/30 transition-all flex items-center justify-center gap-1.5 sm:gap-2"
      >
