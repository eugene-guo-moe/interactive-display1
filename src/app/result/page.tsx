    ...
    <div className="relative flex-1 flex flex-col page-transition overflow-hidden" style={{ backgroundColor: '#050505' }}>
      ...
      <div className="relative z-10 flex flex-col md:flex-row flex-1 min-h-0 overflow-hidden">
        ...
        <div className="flex-1 min-h-0 flex flex-col md:w-1/2 md:flex-none">
          ...
          {/* Generated image */}
          <div className="flex items-center justify-center px-3 md:px-6 py-1 md:py-4 flex-1 min-h-0">
            <div className="relative w-[85vw] max-w-sm md:w-full md:max-w-none h-full max-h-full">
        ...
        <div className="md:w-1/2 md:flex md:flex-col md:justify-center md:items-center md:px-8 md:py-6 shrink-0 md:shrink md:min-h-0">
          ...
          {/* Bottom section with QR + buttons */}
          {showContent && (
            <div className="pt-3 px-4 md:px-0 pb-4 md:pb-0 rounded-t-3xl md:rounded-none slide-up mt-auto md:mt-4 backdrop-blur-sm md:backdrop-blur-none bg-black/40 md:bg-transparent border-t md:border-t-0" style={{ borderColor: `${currentStyle.color}15`, paddingBottom: 'max(1rem, env(safe-area-inset-bottom))' }}>
