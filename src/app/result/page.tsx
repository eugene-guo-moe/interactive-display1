...
export default function ResultPage() {
  ...
  return (
    <div className="relative flex-1 flex flex-col page-transition overflow-y-auto overscroll-contain" style={{ WebkitOverflowScrolling: 'touch', backgroundColor: '#050505' }}>
      ...
      {/* School indicator */}
      <p className="relative z-10 text-white/40 text-xs sm:text-sm tracking-widest text-center pt-4 md:pt-4 md:pb-2 px-4">
        RIVERSIDE SECONDARY SCHOOL, SINGAPORE
      </p>

      {/* Header */}
      <div className="relative z-10 p-3 md:p-2 md:pb-4 pt-1 text-center shrink-0">
        <h1
          className="font-display text-2xl md:text-2xl font-semibold mb-1"
          style={{
        ...
        <p className="text-white/50 text-sm md:hidden">
          {timePeriod === 'past'
            ...
            {displayImageUrl ? (
              <>
                ...
                <img
                  ...
                  className={`w-full h-auto max-h-[55vh] md:max-h-[50vh] object-contain transition-opacity duration-500 ${
      ...
      {showContent && (
        <div
          className="relative z-10 p-4 md:p-3 pb-4 md:pb-3 rounded-t-3xl slide-up shrink-0 mt-auto md:mt-4 backdrop-blur-sm"
          style={{
        ...
        >
          {/* QR Code and info */}
          <div className="flex items-center gap-4 md:gap-3 mb-4 md:mb-3 max-w-md mx-auto">
            <div
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-0.5">
                <svg style={{ color: currentPhase.color }} className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                </svg>
                <p className="text-white/90 font-medium text-sm">Scan to Download</p>
              </div>
              <p className="text-white/50 text-xs leading-relaxed">
                Scan with your phone camera to save your image
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-3 max-w-md mx-auto">
            <button
              ...
              className="btn-press flex-1 py-3 md:py-2.5 rounded-full bg-white/10 border border-white/20 text-white/70 font-medium hover:bg-white/15 hover:text-white transition-all flex items-center justify-center gap-2 text-sm"
            >
            ...
            <button
              ...
              className="btn-press flex-1 py-3 md:py-2.5 rounded-full bg-white/95 hover:bg-white text-[#1e3a5f] font-semibold shadow-2xl shadow-white/20 hover:shadow-white/40 hover:scale-105 transition-all flex items-center justify-center gap-2 text-sm"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          {/* Footer text */}
          <p className="text-center text-white/30 text-xs mt-3 md:mt-2 tracking-wide">
            Made with love at Riverside Secondary
          </p>
        </div>
      )}
